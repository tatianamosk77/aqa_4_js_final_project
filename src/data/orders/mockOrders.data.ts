...
export const MOCK_MANAGER_JACKLINE: IAssignedManager = {
  _id: "680d4d7dd006ba3d475ff67b",
  username: "JackelinePadberg",
  firstName: "Jackeline",
  lastName: "Padberg",
  createdOn: "2025/12/21 22:18:59",
};

export const MOCK_HISTORY_PERFORMER_JACKLINE: IHistoryPerformer = {
  _id: "680d4d7dd006ba3d475ff67b",
  username: "JackelinePadberg",
  firstName: "Jackeline",
  lastName: "Padberg",
...
export const MOCK_HISTORY_CREATED_ALICE: IOrderHistoryItem = {
  ...
  performer: MOCK_HISTORY_PERFORMER_JACKLINE,
...
export const MOCK_ORDER_IN_PROCESS: IOrderFromResponse = {
  ...
  comments: [],
  assignedManager: MOCK_MANAGER_JACKLINE,
};
